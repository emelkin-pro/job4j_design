...
class NonCollisionMapTest {
    ...
    @Test
    void whenGetAllValues() {
        assertThat(map.get(0)).isNull();
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.get(2)).isEqualTo("2");
        assertThat(map.get(3)).isEqualTo("3");
        assertThat(map.get(4)).isEqualTo("4");
        assertThat(map.get(322)).isNull();
    }

    @Test
    void whenPut0AndGetRemoveNull() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.get(null)).isNull();
    ...
    @Test
    void whenPutNullAndGetRemove0() {
        assertThat(map.put(null, "0")).isTrue();
        assertThat(map.get(0)).isNull();
        assertThat(map.remove(0)).isFalse();
        assertThat(map.get(null)).isEqualTo("0");
    }

    @Test
    void whenPut0AndTryPut8() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.get(0)).isEqualTo("0");
    ...
    void whenPut0AndTryRemove8() {
        ...
        assertThat(map.get(0)).isEqualTo("0");
        assertThat(map.put(8, "0")).isFalse();
        assertThat(map.remove(8)).isFalse();
    }
