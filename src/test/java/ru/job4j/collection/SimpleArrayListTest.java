...
class SimpleArrayListTest {
    ...
    void whenSetByNegateIndexThenGetException() {
        assertThatThrownBy(() -> list.set(-3, 22)).isInstanceOf(IndexOutOfBoundsException.class);
    }
    ...
    void whenSetByIncorrectIndexThenGetException() {
        assertThatThrownBy(() -> list.set(5, 22)).isInstanceOf(IndexOutOfBoundsException.class);
    }
    ...
    void whenSetByInvalidIndexThenGetException() {
        list = new SimpleArrayList<>(3);
        list.add(1);
        assertThatThrownBy(() -> list.set(2, 22)).isInstanceOf(IndexOutOfBoundsException.class);
    }
